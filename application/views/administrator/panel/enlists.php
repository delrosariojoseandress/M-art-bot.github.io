                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <small>
                        ...
                        <?php foreach($move_list as $move_tos):       ?>
                            ...
                            <a class="text-center nav-link <?php if($move_tos->action_id == $enlists['action_id']){echo 'text-white bg-gradient-primary';}else{echo ' text-dark';} ?>"href="<?=base_url();?>administrator-enlists-candidates/<?php echo $move_tos->action_id.'/'.$jobs['job_id'];?>">
...
table = $('#recruitment').DataTable(
        {
            ...
            "ajax": {
                "url": "<?php echo site_url('enlists/ajax_list/').$jobs['job_id'].'/'.$enlists["action_id"];?>",
                "type": "POST"
            },
